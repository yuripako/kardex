...
class Cliente extends CI_Controller { 
	...
	{ 
       ...
       $data['modulos'] = $query;        
       //Cargo mis monedas 
       $query2 = $this->Cliente_model->load_cliente(); 
       $data['cliente'] = $query2;      
    ...
    {
       $query = $this->Cliente_model->select_tipodocid();
    ...
    public function bus_tipo()
    {
        ...
        {
            $query = $this->Cliente_model->carga_automatica($tipo); 
    ...
    public function bus_distrito()
    {
        ...
        $query = $this->Cliente_model->busca_ubigeo($valor,$desc);
        switch ($desc) {
            case "distri":                
    ...
    {         
        ...
        $query = $this->Cliente_model->agregar_cliente($valor01,$valor02,$valor03,$valor04,$valor05,
    ...
    { 
        ...
        $query = $this->Cliente_model->actualiza_cliente($valor01,$valor02,$valor03,$valor04,$valor05); 
        echo $query[0]->mensaje;  
       //echo json_encode($query); 
    } 
    public function delcliente(){ 
        $cod = $this->input->post('cod');         
        $query = $this->Cliente_model->borrar_cliente($cod); 
        echo $query[0]->mensaje;  
       //echo json_encode($query); 
