       ...
       <canvas id="myAreaChart" height="0"  style="display: none;"></canvas> 
        ...
        <div class="card mb-3">
          <div class="card-header " style=" background-color: #00a65a;">
           ...
           <button data-toggle="modal" data-target="#modal_lista2" class="btn btn-warning"><i class="fas fa-plus "></i> Agregar  Precio</button>
          </div>
          <div class="card-body ">
        ...
        <form id="form_editroles">
           <input type="hidden" id="ridrol" name="ridrol">
            <div class="form-group row">
              ...
              <div class="col-sm-9">
                <input type="text" class="form-control" id="rrol" name="rrol"  placeholder="LPM_001 EXAMPLE" >
              </div>
            </div>
...
<div class="modal fade" id="modal_lista2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="modal fade" id="modal_lista" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Agregar lista precio</h5>
          <button class="close" type="button" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">×</span>
          </button>
        </div>
