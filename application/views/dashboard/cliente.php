      ...
      <div class="container-fluid">
        ...
        <div class="card mb-3">
          <div class="card-header " style=" background-color: #00a65a;">
           ...
           <button data-toggle="modal"  data-toggle="modal" data-target="#modaladdcliente" class="btn btn-warning"><i class="fas fa-plus "></i> Agregar Cliente</button>
          </div>
          <div class="card-body ">
            <div class="table-responsive">
              <table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody >
                <?php $cont=1; foreach ($cliente as $item) { ?>  
                  <tr >
                     <td><?= $cont++; ?></td>
                     <td><?= $item->nom_emp; ?></td>
                     <td><?= $item->ruc_nif; ?></td>
                     ...
                     <td class="text-center">
                        <div class="btn-group">
                            <button title="ELIMINAR CLIENTE" onclick="eliminar_cliente('<?= $item->id_cliente ?>');" class="btn btn-danger" > <i class="fas fa-trash "></i></button>                          
                            <button title="EDITAR CLIENTE" onclick="actualizar_cliente('<?= $item->id_cliente ?>','<?=$item->nom_emp ?>','<?=$item->tip_doc ?>','<?=$item->ruc_nif ?>','<?=$item->estado ?>');"  data-toggle="modal" data-target="#modaleditarcliente"  class="btn btn-warning"> <i class="fas fa-edit "></i></button> 
                            <button data-toggle="modal" data-target="#modulosper" onclick="detalle_cliente(<?= $item->id_cliente ?>);"   class="btn btn-info btn-sm"> <i class=" fas fa-eye "></i></button>
                        </div>
                    </td>
                  </tr>
                <?php } ?>
...
<div class="modal fade" id="modaladdcliente" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button onclick="agregar_cliente();" type="button" class="btn btn-primary">Guardar</button>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
        <button onclick = "updatecliente();" type="button" class="btn btn-primary">Guardar cambios</button>
      </div>
    </div>
  </div>
</div>
