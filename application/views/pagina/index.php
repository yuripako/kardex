...
<head>
    ...
    <!-- FontAwesome CSS -->
    <link rel="stylesheet" href="<?= base_url('page/css/font-awesome.min.css') ?>">

    <!-- ElegantFonts CSS -->
    <link rel="stylesheet" href="<?= base_url('page/css/elegant-fonts.css') ?>">

    <!-- themify-icons CSS -->
    <link rel="stylesheet" href="<?= base_url('page/css/themify-icons.css') ?>">

    <!-- Swiper CSS -->
    <link rel="stylesheet" href="<?= base_url('page/css/swiper.min.css') ?>">

    <!-- Styles -->
    <link rel="stylesheet" href="<?= base_url('page/style.css') ?>">
</head>
<body>
                ...
                <div class="row">
                    <div class="col-12 d-flex flex-wrap justify-content-between align-items-center">
                        <div class="site-branding d-flex align-items-center">
                           <a class="d-block" href="index.html" rel="home"><img  width="300" height="80" class="d-block" src="<?= base_url('page/images/logo.png')?>" alt="logo"></a>
                        </div><!-- .site-branding -->
    ...
    <div class="swiper-container hero-slider">
        <div class="swiper-wrapper">
            <div class="swiper-slide hero-content-wrap">
                <img src="<?= base_url('page/images/hero.jpg')?>" alt="">
                ...
                <div class="col-12 col-md-6 col-lg-4 mt-4 mt-lg-0">
                    <div class="icon-box active">
                        <figure class="d-flex justify-content-center">
                            <img src="<?= base_url('page/images/hands-gray.png')?>" alt="">
                            <img src="<?= base_url('page/images/hands-white.png')?>" alt="">
                        </figure>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-lg-6 mt-4 order-1 order-lg-2">
                    <img src="<?= base_url('page/images/welcome.jpg')?>" alt="welcome">
                </div><!-- .col -->
            </div><!-- .row -->
        </div><!-- .container -->
    </div><!-- .home-page-icon-boxes -->
                ...
                <div class="col-12 col-lg-6">
                    <div class="upcoming-events">
                        ...
                        <div class="event-wrap d-flex flex-wrap justify-content-between">
                            <figure class="m-0">
                                <img src="<?= base_url('page/images/event-1.jpg')?>" alt="">
                            </figure>
                        ...
                        <div class="event-wrap d-flex flex-wrap justify-content-between">
                            <figure class="m-0">
                                <img src="<?= base_url('page/images/event-2.jpg')?>" alt="">
                            </figure>
                        ...
                        <div class="event-wrap d-flex flex-wrap justify-content-between">
                            <figure class="m-0">
                                <img src="<?= base_url('page/images/event-3.jpg')?>" alt="">
                            </figure>
                ...
                <div class="col-12 col-lg-6">
                    <div class="featured-cause">
                        ...
                        <div class="cause-wrap d-flex flex-wrap justify-content-between">
                            <figure class="m-0">
                                <img src="<?= base_url('page/images/featured-causes.jpg')?>" alt="">
                            </figure>
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="cause-wrap">
                                    <figure class="m-0">
                                        <img src="<?= base_url('page/images/cause-1.jpg')?>" alt="">
                            ...
                            <div class="swiper-slide">
                                <div class="cause-wrap">
                                    <figure class="m-0">
                                        <img src="<?= base_url('page/images/cause-2.jpg')?>" alt="">
                            ...
                            <div class="swiper-slide">
                                <div class="cause-wrap">
                                    <figure class="m-0">
                                        <img src="<?= base_url('page/images/cause-3.jpg')?>" alt="">
                ...
                <div class="col-12 col-lg-6">
                    <div class="milestones d-flex flex-wrap justify-content-between">
                        <div class="col-12 col-sm-4 mt-5 mt-lg-0">
                            <div class="counter-box">
                                <div class="d-flex justify-content-center align-items-center">
                                    <img src="<?= base_url('page/images/teamwork.png')?>" alt="">
                                </div>
                        ...
                        <div class="col-12 col-sm-4 mt-5 mt-lg-0">
                            <div class="counter-box">
                                <div class="d-flex justify-content-center align-items-center">
                                    <img src="<?= base_url('page/images/donation.png')?>" alt="">
                                </div>
                        ...
                        <div class="col-12 col-sm-4 mt-5 mt-lg-0">
                            <div class="counter-box">
                                <div class="d-flex justify-content-center align-items-center">
                                    <img src="<?= base_url('page/images/dove.png')?>" alt="">
                                </div>
                ...
                <div class="row">
                    <div class="col-12 col-md-6 col-lg-3">
                        <div class="foot-about">
                            <h2><a class="foot-logo" href="#"><img src="<?= base_url('page/images/foot-logo.png')?>" alt=""></a></h2>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
    ...
    <script type='text/javascript' src="<?= base_url('page/js/jquery.js') ?>" ></script>
    <script type='text/javascript' src="<?= base_url('page/js/jquery.collapsible.min.js') ?>"></script>
    <script type='text/javascript' src="<?= base_url('page/js/swiper.min.js') ?>"></script>
    <script type='text/javascript' src="<?= base_url('page/js/jquery.countdown.min.js') ?>"></script>
    <script type='text/javascript' src="<?= base_url('page/js/circle-progress.min.js') ?>"></script>
    <script type='text/javascript' src="<?= base_url('page/js/jquery.countTo.min.js') ?>"></script>
    <script type='text/javascript' src="<?= base_url('page/js/jquery.barfiller.js') ?>"></script>
    <script type='text/javascript' src="<?= base_url('page/js/custom.js') ?>"></script>
